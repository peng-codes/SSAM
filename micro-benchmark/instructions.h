...
#define ALL(a, b)	a=__all_sync(0xFFFFFFFF, a==b)
#define ANY(a, b)	a=__any_sync(0xFFFFFFFF, a==b)
#define SHFL_UP(a, b) a=__shfl_up_sync(0xFFFFFFFF, b, 32)
#define SHFL_DOWN(a, b) a=__shfl_down_sync(0xFFFFFFFF, b, 32)
#define SHFL_XOR(a, b) a=__shfl_xor_sync(0xFFFFFFFF, b, 32)
#else
#pragma message("CUDART_VERSION < 9000")
#define ALL(a, b)	a=__all(a==b)
#define ANY(a, b)	a=__any(a==b)
#define SHFL_UP(a, b) a=__shfl_up(b, 32)
#define SHFL_DOWN(a, b) a=__shfl_down(b, 32)
#define SHFL_XOR(a, b) a=__shfl_xor(b, 32)
#endif
...
//Warp Shfl Functions
//K_2OP_DEP(SHFL_DOWN, SHFL_UP, 128, FLOAT)
K_OP_DEP(SHFL_DOWN, 128, FLOAT)
K_OP_DEP(SHFL_UP, 128, FLOAT)
K_OP_DEP(SHFL_XOR, 128, FLOAT)
